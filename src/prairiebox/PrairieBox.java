...
public class PrairieBox extends MIDlet implements CommandListener, ItemCommandListener, LocationListener {
    ...
    public Form getAuthScreen() {
            if (authScreen == null) {
                ...
                // write pre-init user code here
                authScreen = new Form("Login", new Item[] {
                    getConnectionstatusItem(), getTokenField(), getAuthScreenSpacer1(), getSavetokenButton(), getAuthScreenSpacer2(), getAuthScreenExplainer()
                }); //GEN-BEGIN:|23-getter|1|23-postInit
    ...
    public List getRecentCheckinsList() {
            if (recentCheckinsList == null) {
                ...
                recentCheckinsList.setSelectedFlags(new boolean[] {
                    false
                }); //GEN-END:|103-getter|1|103-postInit
                // write post-init user code here
    ...
    public Form getCurrentLocation() {
            if (currentLocation == null) {
                ...
                // write pre-init user code here
                currentLocation = new Form("Current Location", new Item[] {
                    getInfo(), getStringItem()
                }); //GEN-BEGIN:|124-getter|1|124-postInit
    ...
    public List getNearbyVenuesList() {
            if (nearbyVenuesList == null) {
                ...
                nearbyVenuesList.setSelectedFlags(new boolean[] {
                    false
                }); //GEN-END:|136-getter|1|136-postInit
                // write post-init user code here
...
//GEN-END:|136-action|3|136-postAction
    ...
    public Form getCheckedIn() {
            if (checkedIn == null) {
                ...
                // write pre-init user code here
                checkedIn = new Form("Check In", new Item[] {
                    getCheckInString()
                }); //GEN-BEGIN:|155-getter|1|155-postInit
    ...
    public Form getCheckingIn() {
            if (checkingIn == null) {
                ...
                // write pre-init user code here
                checkingIn = new Form("Checking In", new Item[] {
                    getMyVenueString(), getShoutField()
                }); //GEN-BEGIN:|178-getter|1|178-postInit
